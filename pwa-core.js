const PWA_CONFIG = {
  APP_NAME:    'Rung Chuông Vàng',
  APP_DESC:    'Trò chơi đối kháng trực tiếp online',
...
document.addEventListener('DOMContentLoaded', function onDOMReady() {
    ...
    <div id="pwa-card">
      ...
      <div id="pwa-block-ios" hidden>
        ...
        <div class="pwa-step">
          ...
          <div class="pwa-step-text">Nhấn nút <b>Chia sẻ</b> 📤 ở thanh Safari phía dưới</div>
        </div>
        <div class="pwa-step">
          <div class="pwa-step-num">2</div>
          <div class="pwa-step-text">Cuộn xuống, chọn <b>"Thêm vào Màn hình chính"</b> 🏠</div>
        </div>
        <div class="pwa-step">
          <div class="pwa-step-num">3</div>
          <div class="pwa-step-text">Nhấn <b>"Thêm"</b> ở góc trên bên phải ✅</div>
        </div>
        <div class="pwa-after-note">
  ...
  // QUAN TRỌNG: Chỉ xử lý overlay khi KHÔNG ở standalone mode
  if (!isStandalone) {
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
      e.preventDefault();
      deferredPrompt = e;
      if (isIOS) return; // iOS không có beforeinstallprompt
